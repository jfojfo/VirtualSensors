...
*
*/
public class TYPE_LINEAR_ACCELERATION extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.lineracc);
                View_init();
                pojectinit();
        }
        ...
        private void pojectinit(){
                ...
                illuminationSensor=sensorManager.getDefaultSensor(Sensor.TYPE_LINEAR_ACCELERATION);
